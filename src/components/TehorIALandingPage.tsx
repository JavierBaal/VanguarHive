...
const TehorIALandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-900">
      ...
      {/* El Visionario Disruptivo - About Section */}
      <section className="py-20 px-4 md:px-8 lg:px-16 bg-slate-900">
        <div className="max-w-7xl mx-auto">
          <div className="mb-16 text-center">
            <div className="flex items-center justify-center mb-4">
              <span className="text-sm font-medium text-pink-400 mr-2">05</span>
              <div className="h-px w-8 bg-pink-400"></div>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              className="relative"
            >
              <div className="aspect-square w-full max-w-md mx-auto bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl shadow-2xl overflow-hidden border-2 border-slate-700">
                <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-5"></div>

                {/* Profile image placeholder with gradient overlay */}
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center p-6 z-10">
                    <div className="w-32 h-32 mx-auto rounded-full bg-gradient-to-r from-cyan-500 to-purple-500 flex items-center justify-center mb-4">
                      <span className="text-4xl text-white font-bold">JB</span>
                    </div>
                    <h3 className="text-2xl font-bold mb-2 text-white">
                      Javier Baal
                    </h3>
                    <p className="text-cyan-400 mb-4">
                      Fundador de VanguardHIVE
                    </p>
                ...
                {/* Decorative elements */}
                <motion.div
                  className="absolute w-[200px] h-[200px] rounded-full bg-gradient-to-r from-cyan-500 to-purple-500 opacity-20 blur-3xl"
                  animate={{
                    x: [0, 30, 0],
                    y: [0, -30, 0],
                    scale: [1, 1.1, 1],
            ...
            >
              <div className="space-y-6 text-slate-300">
                <p className="text-xl font-light leading-relaxed">
                  Javier Baal no simplemente ha sido testigo de la revolución
                  tecnológica—la ha vivido, respirado y transformado desde
                  dentro.
                </p>

                <p className="leading-relaxed">
                  Desde aquel Commodore 16 que recibió a sus 11 años en 1984,
                  Javier ha navegado cada ola tecnológica no como un observador,
                  sino como un visionario capaz de percibir patrones donde otros
                  ven caos. Su mente neurodivergente de altas capacidades no es
                  solo una característica—es su superpoder en la era digital.
                </p>

                <p className="leading-relaxed">
                  Como director creativo tecnológico, reinventó la publicidad
                  BTL para marcas icónicas como El Corte Inglés, Sony
                  PlayStation y Häagen-Dazs. Pero fue en 2020, cuando los
                  primeros modelos GPT emergían en el horizonte tecnológico,
                  cuando Javier vislumbró lo que pocos podían imaginar: el
                  verdadero potencial transformador de la inteligencia
                  artificial.
                </p>

                <p className="leading-relaxed">
                  Vanguard Hive nace de esta visión singular—un laboratorio de
                  innovación donde la IA no es simplemente una herramienta, sino
                  un nuevo lenguaje para resolver los desafíos más complejos de
                  nuestro tiempo. Su enfoque único, alimentado por su sinestesia
                  y pensamiento divergente, crea soluciones que desafían los
                  límites de lo posible.
                </p>

                <p className="text-xl font-semibold text-cyan-400">
                  Este no es solo otro proyecto de tecnología. Es una revolución
                  silenciosa que está reescribiendo las reglas del juego.
                </p>

                <p className="text-lg font-medium text-white">
                  Bienvenidos al futuro, rediseñado por Vanguard Hive.
                </p>
              </div>
            </motion.div>
          </div>
